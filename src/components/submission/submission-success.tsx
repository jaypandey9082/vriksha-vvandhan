...
export function SubmissionSuccess() {
  ...
  return (
    <section className="submission-success" aria-labelledby="submission-success-title">
      ...
      <p>
        Our team will review your photograph before it appears publicly. If approved, it will be added to the Vriksha Vvandhan Movement Wall, included in the campaign count, and your personalised Vriksha Guardian certificate will be emailed to the address you provided.
      </p>
      ...
      <Link className="button button--primary" href="/">
        <ArrowLeft aria-hidden="true" size={18} /> Back to the Movement
      </Link>
    </section>
  );
}
