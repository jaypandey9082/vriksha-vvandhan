...
describe("safe public campaign data", () => {
  ...
  it("validates summary and builds only public Storage URLs", async () => {
    ...
    const fetchMock = vi.fn()
      ...
      .mockResolvedValueOnce(new Response(JSON.stringify([{ guardian_number: 7, display_name: "Asha", published_at: "2026-08-06T12:00:00.000Z", card_path: "card/7-v1.webp", card_width: 640, card_height: 800, full_path: "full/7-v1.webp", full_width: 1200, full_height: 900, alt_text: "A tree", focal_x: .5, focal_y: .5 }])));
