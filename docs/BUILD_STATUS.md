...
Section 4 adds invite-only Reviewer/Admin access, private signed review, atomic moderation/publication RPCs, immutable public WebP variants, the real homepage count, approved preview, and `/movement`. Its queue is hardened with automatic private 240×300 review thumbnails, deferred one-batch signing and bounded keyset pages. Certificate and email records remain `not_started`; no certificate or campaign email is generated or sent.
